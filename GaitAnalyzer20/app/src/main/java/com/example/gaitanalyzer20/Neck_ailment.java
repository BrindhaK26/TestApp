...
public class Neck_ailment extends AppCompatActivity {
    ...
    //initialize fields
    EditText radiate,illness,injury,severity,stiff_neck,headache,doc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.neck_ailment);

        //assign fields
        radiate = findViewById(R.id.neck_ans3);
        injury = findViewById(R.id.neck_ans1);
        severity = findViewById(R.id.neck_ans2);
        stiff_neck = findViewById(R.id.neck_ans4);
        headache = findViewById(R.id.neck_ans5);
        doc = findViewById(R.id.neck_ans6);
        next = findViewById(R.id.button9);
        illness = findViewById(R.id.illnes_duration1);
        greet = findViewById(R.id.textView);
        selectPic = findViewById(R.id.Choose_pic_neck);
        ...
        v1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PopupMenu pm = new PopupMenu(Neck_ailment.this, v);
            ...
            public void onClick(View v) {
                ...
                pm.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.X:
                                Toast.makeText(Neck_ailment.this, "Signed out successfully!", Toast.LENGTH_SHORT).show();
                            ...
                            case R.id.Y:
                                Toast.makeText(Neck_ailment.this, "Redirecting to help page...", Toast.LENGTH_SHORT).show();
                                return true;
                        }
                        return true;
                    }
        ...
        selectPic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(ContextCompat.checkSelfPermission(Neck_ailment.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    Intent i = new Intent();
                    i.setType("image/*");
        ...
        //validate fields
        awesomeValidation.addValidation(this, R.id.neck_ans1, "^Yes$|^No$|^yes$|^no$", R.string.invalid);
        awesomeValidation.addValidation(this, R.id.illnes_duration1, Range.closed(0, 100), R.string.invalid_duration);
        awesomeValidation.addValidation(this, R.id.neck_ans3, "^Yes$|^No$|^yes$|^no$", R.string.invalid);
        awesomeValidation.addValidation(this, R.id.neck_ans2, Range.closed(0, 3), R.string.invalid);
        awesomeValidation.addValidation(this, R.id.neck_ans4, "^Yes$|^No$|^yes$|^no$", R.string.invalid);
        awesomeValidation.addValidation(this, R.id.neck_ans5, "^Yes$|^No$|^yes$|^no$", R.string.invalid);
        awesomeValidation.addValidation(this, R.id.neck_ans6, "^Yes$|^No$|^yes$|^no$", R.string.invalid);
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(imagePath!=null) {
                    if (awesomeValidation.validate()) {
                        ...
                        //if (count <= 6) {
                            if (Doc_seen.equals("Yes") || Doc_seen.equals("yes")) {
                                intent = new Intent(Neck_ailment.this, Treatment_details.class);
                                intent.putExtra("activity", "Neck_ailment");
                            } else {
                                //intent = new Intent(context, Treatment_details.class);
                                intent = new Intent(context, Start_record_neck1.class);
                            }
                       // } else {
                    ...
                    Toast.makeText(Neck_ailment.this, "Please first select a photo that clearly shows your face", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    //radiate,illness,injury,severity,stiff_neck,headache,doc
    private void addNeckDetails() {
        count++;
       /* if(count>6){
            Toast.makeText(Neck_ailment.this,"Oops your treatment period of 6 months is over! Hope you are better than before now! Have a good day! Bye",Toast.LENGTH_LONG).show();
            Intent intent = new Intent(context, Ailment.class);
            startActivity(intent);
            finish();
        }else {*/
            String current_month = "month" + count;
            String Radiate = radiate.getText().toString();
            String Injury = injury.getText().toString();
            String Stiff = stiff_neck.getText().toString();
            ...
            String Headache = headache.getText().toString();
            String Doc = doc.getText().toString();
            NeckDetails u1 = new NeckDetails(Illness, Radiate, Injury, Severity, Stiff, Headache, Doc, imagePath);
    ...
    private void getCount() {
        databaseUsers2.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull @NotNull DatabaseError error) {
                Toast.makeText(Neck_ailment.this, "OOps couldn't fetch data",Toast.LENGTH_SHORT).show();
            }
        });
            ...
            new AlertDialog.Builder(this).setTitle("Permission needed")
                    ...
                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(Neck_ailment.this,new String []{Manifest.permission.READ_EXTERNAL_STORAGE},PICK_FROM_GALLERY);
                        }
                    })
