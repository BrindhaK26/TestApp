...
public class Start_record_lb1 extends AppCompatActivity {
    ...
    DatabaseReference databaseUsers,databaseUsers2,databaseUsers4;
    FirebaseAuth auth;
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_record_lb1);

        rec = findViewById(R.id.rec_lb1);
        ...
        v1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PopupMenu pm = new PopupMenu(Start_record_lb1.this, v);
            ...
            public void onClick(View v) {
                ...
                pm.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.X:
                                Toast.makeText(Start_record_lb1.this, "Signed out successfully!", Toast.LENGTH_SHORT).show();
                            ...
                            case R.id.Y:
                                Toast.makeText(Start_record_lb1.this, "Redirecting to help page...", Toast.LENGTH_SHORT).show();
                                return true;
                        }
                        return true;
                    }
                ...
                new ActivityResultContracts.StartActivityForResult(), result -> {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                       ...
                       PyObject obj = pyobj.callAttr("main",path,imagePath);
                        ...
                        String spd1 = String.valueOf(score1);

                        Intent intent = new Intent(context,Start_record_lb2.class);

                        intent.putExtra("spd1",spd1);
                        startActivity(intent);
                        finish();
                    }
                });
        ...
        rec.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(imagePath!=null) {
                    if (ContextCompat.checkSelfPermission(Start_record_lb1.this,
                        ...
                        if (takeVideoIntent.resolveActivity(getPackageManager()) != null) {
                            ...
                            Toast.makeText(Start_record_lb1.this, "Error...", Toast.LENGTH_SHORT).show();
                        }
                    } else {
    ...
    private void getImgPath() {
        databaseUsers4.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull @NotNull DatabaseError error) {
                Toast.makeText(Start_record_lb1.this, "OOps couldn't fetch image path",Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getCount() {
        databaseUsers2.addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull @NotNull DatabaseError error) {
                Toast.makeText(Start_record_lb1.this, "OOps couldn't fetch data",Toast.LENGTH_SHORT).show();
            }
        });
            ...
            new AlertDialog.Builder(this).setTitle("Permission needed")
                    ...
                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(Start_record_lb1.this,new String []{Manifest.permission.CAMERA},CAMERA_PERMISSION);
                        }
                    })
