...
public class Lower_back_ailment extends AppCompatActivity {
    ...
    //initialize fields
    EditText radiate,illness,injury,severity,walk_problem,walk_aid,doc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lower_back_ailment);

        //assign fields
        radiate = findViewById(R.id.lb_ans2);
        injury = findViewById(R.id.lb_ans1);
        severity = findViewById(R.id.lb_ans3);
        walk_problem = findViewById(R.id.lb_ans4);
        walk_aid = findViewById(R.id.lb_ans5);
        next = findViewById(R.id.button8);
        doc = findViewById(R.id.lb_ans6);
        illness = findViewById(R.id.illnes_duration3);
        greet = findViewById(R.id.textView);
        selectPic = findViewById(R.id.Choose_pic_lb);
        ...
        v1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PopupMenu pm = new PopupMenu(Lower_back_ailment.this, v);
            ...
            public void onClick(View v) {
                ...
                pm.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.X:
                                Toast.makeText(Lower_back_ailment.this, "Signed out successfully!", Toast.LENGTH_SHORT).show();
                            ...
                            case R.id.Y:
                                Toast.makeText(Lower_back_ailment.this, "Redirecting to help page...", Toast.LENGTH_SHORT).show();
                                return true;
                        }
                        return true;
                    }
        ...
        selectPic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(ContextCompat.checkSelfPermission(Lower_back_ailment.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    Intent i = new Intent();
                    i.setType("image/*");
        ...
        //validate fields
        awesomeValidation.addValidation(this,R.id.lb_ans1, "^Yes$|^No$|^yes$|^no$", R.string.invalid);
        awesomeValidation.addValidation(this, R.id.illnes_duration3, Range.closed(0,100), R.string.invalid_duration);
        awesomeValidation.addValidation(this,R.id.lb_ans2, "^Yes$|^No$|^yes$|^no$", R.string.invalid);
        awesomeValidation.addValidation(this,R.id.lb_ans3,  Range.closed(0,3), R.string.invalid);
        awesomeValidation.addValidation(this,R.id.lb_ans4, "^Yes$|^No$|^yes$|^no$", R.string.invalid);
        awesomeValidation.addValidation(this,R.id.lb_ans5, "^Yes$|^No$|^yes$|^no$", R.string.invalid);
        awesomeValidation.addValidation(this,R.id.lb_ans6, "^Yes$|^No$|^yes$|^no$", R.string.invalid);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(imagePath!=null) {
                    if (awesomeValidation.validate()) {
                        ...
                        //if (count <= 6) {
                            if (Doc_seen.equals("Yes") || Doc_seen.equals("yes")) {
                                intent = new Intent(Lower_back_ailment.this, Treatment_details.class);
                                intent.putExtra("activity", "Lower_back_ailment");
                            } else {
                                intent = new Intent(context, Start_record_lb1.class);
                            }
                        //} else {
                    ...
                    Toast.makeText(Lower_back_ailment.this,"Please first select a photo that clearly shows your face",Toast.LENGTH_LONG).show();
    ...
    private void addLbDetails() {
        count++;
      /*  if (count > 6) {
            Toast.makeText(Lower_back_ailment.this, "Oops your treatment period of 6 months is over! Hope you are better than before now! Have a good day! Bye", Toast.LENGTH_LONG).show();
            ...
            LbDetails u1 = new LbDetails(Illness, Injury, Radiate, Severity, Walk_prob, Walk_aid, Doc,imagePath);
    ...
    private void getCount() {
        databaseUsers2.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull @NotNull DatabaseError error) {
                Toast.makeText(Lower_back_ailment.this, "OOps couldn't fetch data",Toast.LENGTH_SHORT).show();
            }
        });
            ...
            new AlertDialog.Builder(this).setTitle("Permission needed")
                    ...
                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(Lower_back_ailment.this,new String []{Manifest.permission.READ_EXTERNAL_STORAGE},PICK_FROM_GALLERY);
                        }
                    })
