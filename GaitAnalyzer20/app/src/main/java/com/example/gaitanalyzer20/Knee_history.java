...
public class Knee_history extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.knee_history);

        linearLayout = (LinearLayout) findViewById(R.id.Knee_history_layout);
        ...
        v1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PopupMenu pm = new PopupMenu(Knee_history.this, v);
            ...
            public void onClick(View v) {
                ...
                pm.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.X:
                                Toast.makeText(Knee_history.this, "Signed out successfully!", Toast.LENGTH_SHORT).show();
                                FirebaseAuth.getInstance().signOut();

                                Intent intent = new Intent(Knee_history.this,MainActivity.class);
                                startActivity(intent);
                                finish();
                                return true;

                            case R.id.Y:
                                Toast.makeText(Knee_history.this, "Redirecting to help page...", Toast.LENGTH_SHORT).show();
                                return true;
                        }
        ...
        databaseUsers2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (count > 0){
                    ...
                    TextView t1 = new TextView(Knee_history.this);
            ...
            public void onCancelled(@NonNull @NotNull DatabaseError error) {
                Toast.makeText(Knee_history.this, "OOps couldn't fetch data",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void getKneeData() {
        for(int i=1;i<=count;i++) {
            ...
            databaseUsers1 = FirebaseDatabase.getInstance().getReference().child("Users").child(id).child("Kneedetails").child(month);
            DatabaseReference dbRef = databaseUsers1.child("KneeData");
            int finalI = i;
            dbRef.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                    KneeData l1 = snapshot.getValue(KneeData.class);
                    score1 = l1.gait_speed_forward;
                    score2 = l1.gait_speed_backward;
                    score3 = l1.gait_level_surface;
                    setData(finalI);
